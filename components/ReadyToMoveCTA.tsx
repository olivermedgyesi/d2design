...
export function ReadyToMoveCTA() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12">
          <div className="lg:col-span-8">
            <h2 className="font-display text-4xl leading-[1.05] text-paper md:text-5xl lg:text-6xl">
              Interested in an Upcoming Project?
            </h2>
            <p className="mt-8 max-w-xl text-base leading-[1.75] text-paper/80 md:text-lg">
              D2 takes on a limited number of these each year. If you want to
              know about upcoming projects before they&apos;re listed
              publicly, reach out and we&apos;ll add you to the list.
            </p>
            <Link
              href="/contact"
