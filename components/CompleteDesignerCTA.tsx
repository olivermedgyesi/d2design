...
export function CompleteDesignerCTA() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12">
          <div className="lg:col-span-8">
            <h2 className="font-display text-4xl leading-[1.05] text-paper md:text-5xl lg:text-6xl">
              Ready to Redesign the Whole House?
            </h2>
            <p className="mt-8 max-w-xl text-base leading-[1.75] text-paper/80 md:text-lg">
              A whole-home renovation is a significant project. The discovery
              call is where we understand the scope, confirm the fit, and
              give you a realistic picture of the process before anything
              gets committed.
            </p>
            <Link
              href="/contact"
