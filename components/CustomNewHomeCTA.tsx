...
export function CustomNewHomeCTA() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12">
          <div className="lg:col-span-8">
            ...
            <p className="mt-8 max-w-xl text-base leading-[1.75] text-paper/80 md:text-lg">
              Custom new home projects have a longer lead time than most
              people expect. The earlier the design conversation starts, the
              better the outcome. Tell us about the lot and the brief and
